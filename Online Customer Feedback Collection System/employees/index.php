...
<div class="container">
    <div class="page">
        <div class="left">
            <h1>Employees</h1>
            <ul class="breadcrumb">
                <li><a href="./?page=add_employee">Manage Employees</a></li>
    ...
    <div class="Table">
        <div class="cardHeader">
            <a href="./?page=add_employee" class="btn-add">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>";
                        echo "<td>".$x."</td>";
                        echo "<td><img src='images/".$row["image"]."' alt='Employee Image' style='width: 50px; height: 50px; border-radius: 50%;'></td>";
                        echo "<td>".$row["First_name"]."</td>";
                        echo "<td>".$row["Last_name"]."</td>";
                        echo "<td>".$row["Email"]."</td>";
                        echo "<td>";
                        echo "<a href='./?page=add_employee&id=".$row["Employee_ID"]."' class='action-btn update'>Update</a>";
                        echo "<a href='delete.php?table=employee&id=".$row["Employee_ID"]."' class='action-btn delete'>Delete</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                } else {
